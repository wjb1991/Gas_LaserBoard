...
//| 函数设计 | wjb
//==================================================================================
BOOL Mod_SetRiseDots(void * pv_Wave,INT16U uin_Dots,BOOL b_WriteEPROM)
{
    Wave_t* p = pv_Wave;
    if( p != NULL)
    {
        ...
        {
            p->uin_RiseDot = uin_Dots;
            p->uin_SampleDot = uin_Dots;
...
//| 函数设计 | wjb
//==================================================================================
BOOL Mod_SetHighDots(void * pv_Wave,INT16U uin_Dots,BOOL b_WriteEPROM)
{
    Wave_t* p = pv_Wave;
    if( p != NULL)
    {
        if(uin_Dots >= DEF_LEVENDOT_MIN && uin_Dots <= DEF_LEVENDOT_MAX)
        {
            ...
            if(b_WriteEPROM == TRUE)
            {
                if(SaveToEeprom((INT32U)&p->uin_HigtDot) != TRUE)
                    return FALSE;
            }
            p->b_GenerateWave = TRUE;
            return TRUE;
...
//| 函数设计 | wjb
//==================================================================================
BOOL Mod_SetLowDots(void * pv_Wave,INT16U uin_Dots,BOOL b_WriteEPROM)
{
    Wave_t* p = pv_Wave;
    if( p != NULL)
    {
        if(uin_Dots >= DEF_LEVENDOT_MIN && uin_Dots <= DEF_LEVENDOT_MAX)
        {
            ...
            if(b_WriteEPROM == TRUE)
            {
                if(SaveToEeprom((INT32U)&p->uin_LowDot) != TRUE)
                    return FALSE;
            }
            p->b_GenerateWave = TRUE;
            return TRUE;
...
//| 函数设计 | wjb
//==================================================================================
BOOL Mod_SetFallDots(void * pv_Wave,INT16U uin_Dots,BOOL b_WriteEPROM)
{
    Wave_t* p = pv_Wave;
    if( p != NULL)
    {
        if(uin_Dots >= DEF_FALLDOT_MIN && uin_Dots <= DEF_FALLDOT_MAX)
        {
            p->uin_FallDot = uin_Dots;
            if(b_WriteEPROM == TRUE)
            {
                if(SaveToEeprom((INT32U)&p->uin_FallDot) != TRUE)
                    return FALSE;
            }
            p->b_GenerateWave = TRUE;
            return TRUE;
