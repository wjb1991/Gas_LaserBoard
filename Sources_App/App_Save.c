...
START_ADD+0x4000 + 0x18, (uint32_t)(&st_ModWave.uin_HigtDot),   KIND_INT16U,1,  LIMIT_RANGE,  DEF_SAMPLEDOT_MIN,    DEF_SAMPLEDOT_MAX,  2000,
...
START_ADD+0x4000 + 0x24, (uint32_t)(&st_LaserTEC.f_SetCtrlVolt),KIND_FP32,  1,  LIMIT_RANGE,  DEF_TECVOLT_MIN,	    DEF_TECVOLT_MAX, 	1.25,


//START_ADD+0x4000 + 0x1c, (uint32_t)(&st_ModDLia.f_PsdPhase),KIND_FP32, 1, LIMIT_RANGE,  	  0, 					360, 		  0,
